...
apt install -y docker.io nodejs npm mariadb-common mariadb-server mariadb-client php7.3 php7.3-cli php7.3-gd php7.3-mysql php7.3-pdo php7.3-mbstring php7.3-tokenizer php7.3-bcmath php7.3-xml php7.3-fpm php7.3-curl php7.3-zip mariadb-server apache2 libapache2-mod-php7.3 redis-server certbot curl
