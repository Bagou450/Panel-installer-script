...
php composer.phar install --no-dev --optimize-autoloaders
echo "50%"
sleep 3
...
sleep 4
php artisan p:user:make --email mail@exemple.com --username administrateur --name-first exemple --name-last name --password ${userpass} --admin 1
