...
apt install -y nodejs mariadb-common mariadb-server mariadb-client php7.3 php7.3-fpm php7.3-mysql php7.3-pgsql php7.3-bcmath php7.3-mbstring php7.3-xml php7.3-curl php7.3-zip php7.3-gd mariadb-server apache2 libapache2-mod-php7.3 certbot curl unzip zip
