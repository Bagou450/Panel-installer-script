...
echo "deb http://fr.archive.ubuntu.com/ubuntu/ focal main universe " >> /etc/apt/sources.list
echo "deb-src http://fr.archive.ubuntu.com/ubuntu/ focal main universe " >> /etc/apt/sources.list
echo "" >> /etc/apt/sources.list
echo "deb http://fr.archive.ubuntu.com/ubuntu/ focal-security main universe " >> /etc/apt/sources.list
echo "deb http://fr.archive.ubuntu.com/ubuntu/ focal-updates main universe " >> /etc/apt/sources.list
echo "" >> /etc/apt/sources.list
echo "deb-src http://fr.archive.ubuntu.com/ubuntu/ focal-security main universe " >> /etc/apt/sources.list
echo "deb-src http://fr.archive.ubuntu.com/ubuntu/ focal-updates main universe " >> /etc/apt/sources.list
